...
const { solicitudesPendientes, solicitudesCambioPendientes, resumenDelPeriodo, numeroDeEmpleado } = require("./db");
...
router.post("/api/login", (req, res) => {
  ...
  if (!process.env.ADMIN_API_KEY || password !== process.env.ADMIN_API_KEY) {
